      ...
      <el-scrollbar class="right-scrollbar">
        ...
        <el-form v-show="currentTab==='field' && showField" size="small" label-width="90px">
         ...
         <!-- <el-form-item v-if="activeData['prefix-icon']!==undefined" label="前图标">
          ...
          <template v-if="['s-checkbox-group', 's-radio-group', 's-select'].indexOf(activeData.__config__.tag) > -1">
          ...
          <!--表格-->
          <template v-if="activeData.__config__.columnKey">
            ...
            >
              <div v-for="(item, index) in activeData.__slot__.options" :key="index" class="select-item">
                ...
                <div>
                  <el-row>
                    <el-col :span="12">
                      <span style="line-height: 34px">label：</span>
                      <el-input v-model="item.label" placeholder="选项名" size="small" style="width: 50%"/>
                    </el-col>
                    <el-col :span="12">
                      <span style="line-height: 34px;">prop：</span>
                      <el-input placeholder="" size="small"
                                v-model="item.prop" style="width: 50%" @input="setOptionValue(item, $event)"/>
                    </el-col>
                  </el-row>
                </div>
                <div class="close-btn select-line-icon" @click="activeData.__slot__.options.splice(index, 1)">
